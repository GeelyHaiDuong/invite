...
function validateCampaignForm() {
  ...
  if (!validUrl(w)) throw new Error("Địa chỉ Worker không hợp lệ.");
...
function exportCsv() {
  ...
  const header = ["Tên khách","Trạng thái","Link","Thời gian copy","Thời gian gửi","Thời gian xác nhận","Thời gian không tham dự"];
...
onAuthStateChanged(auth, async user => {
  if (user) {
    ...
    if (savedCampaign) {
      ...
      setStatus(campaignStatus, "Nhập Mã chiến dịch, Worker và Link thiệp để bắt đầu.");
    }
  } else {
